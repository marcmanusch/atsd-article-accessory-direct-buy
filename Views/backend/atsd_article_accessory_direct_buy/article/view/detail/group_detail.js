...
Ext.define('Shopware.apps.Article.view.accessory.detail.GroupDetail', {
    ...
    snippets: {
        ...
        groupDetailsDescriptionLabel: '{s name=group_details/description_label}Beschreibung{/s}',
        groupDetailsMultipleChoiceLabel: '{s name=group_details/multiple_choice_label}Mehrfachauswahl{/s}',
        accessoryCancelButton: '{s name=cancel_button}Abbrechen{/s}',
        accessorySaveButton: '{s name=save_button}Speichern{/s}'
    },

    title: '{s name=group_details/title}Gruppen Details{/s}',
        ...
        var accessoryForm = Ext.create('Ext.form.Panel', {
            ...
            items:[
                ...
                /*
                {
                    ...
                    fieldLabel: me.snippets.groupDetailsMultipleChoiceLabel,
                    allowBlank:true
                },
                */
