...
Ext.define('Shopware.apps.Article.view.accessory.detail.AccessoryGridLeft', {
    ...
    snippets: {
        accessoryGroupsEditButton: '{s name=accessory_groups/edit_button}Gruppe editieren{/s}',
        accessoryDeleteSingleGroupButton: '{s name=accessory_groups/delete_button}Gruppe löschen{/s}',
        accessoryGroupsColumnName: '{s name=accessory_groups/column/name}Name{/s}',
        accessoryGroupsColumnDescription: '{s name=accessory_groups/column/description}Beschreibung{/s}',
        accessoryGroupsColumnMultipleChoice: '{s name=accessory_groups/column/multiple_choice}Mehrfachauswahl{/s}',
        accessoryGroupsColumnMultipleChoiceYes: '{s name=accessory_groups/column/multiple_choice_yes}Ja{/s}',
        accessoryGroupsColumnMultipleChoiceNo: '{s name=accessory_groups/column/multiple_choice_no}Nein{/s}',
        accessoryGroupsColumnCount: '{s name=accessory_groups/column/count}Anzahl Artikel{/s}',
        accessoryGroupsToolBarLabel: '{s name=accessory_groups/toolBar/label}Gruppe hinzufügen{/s}',
        accessoryGroupsToolBarAddButton: '{s name=accessory_groups/toolBar/add_button}Gruppe hinzufügen{/s}',
        accessoryGroupsToolBarDeleteButton: '{s name=accessory_groups/toolBar/delete_button}Markierte Gruppen löschen{/s}',
        accessoryActionColumn: '{s name=actioncolumn}Aktionen{/s}'
    },
        ...
        var columns = [
            {
                ...
                header: me.snippets.accessoryGroupsColumnMultipleChoice,
                dataIndex: 'multiple_choice',
                flex: 2,
                renderer: this.renderMultipleChoiceColumn
            },{
    ...
    renderMultipleChoiceColumn: function(value)
    {
        
        if ( value == 1 )
            return this.snippets.accessoryGroupsColumnMultipleChoiceYes;
        else
            return this.snippets.accessoryGroupsColumnMultipleChoiceNo;
    }
