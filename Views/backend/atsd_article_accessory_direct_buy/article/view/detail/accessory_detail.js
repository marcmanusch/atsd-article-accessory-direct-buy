...
Ext.define('Shopware.apps.Article.view.accessory.detail.AccessoryDetail', {
    ...
    snippets: {
        accessoryDetailsOptionNameLabel: '{s name=accessory_details/optionname_label}Name{/s}',
        accessoryDetailsQuantityLabel: '{s name=accessory_details/quantity_label}Anzahl{/s}',
        accessoryCancelButton: '{s name=cancel_button}Abbrechen{/s}',
        accessorySaveButton: '{s name=save_button}Speichern{/s}'
    },

    title: '{s name=accessory_details/title}Details{/s}',
        ...
        var accessoryForm = Ext.create('Ext.form.Panel', {
            ...
            items:[
                ...
                },
                {
                    xtype:'numberfield',
                    name:'quantity',
                    fieldLabel: me.snippets.accessoryDetailsQuantityLabel,
                    maxValue:99,
                    minValue:1,
                    required: true
                }
