...
Ext.define('Shopware.apps.Article.view.accessory.detail.AccessoryGridRight', {
    ...
    snippets: {
        accessoryArticlesEditButton: '{s name=accessory_articles/edit_button}Artikel editieren{/s}',
        accessoryDeleteSingleArticleButton: '{s name=accessory_articles/delete_button}Artikel löschen{/s}',
        accessoryArticlesColumnArticleName: '{s name=accessory_articles/column/article_name}Artikel{/s}',
        accessoryArticlesColumnOptionName: '{s name=accessory_articles/column/option_name}Option{/s}',
        accessoryArticlesColumnQuantity: '{s name=accessory_articles/column/quantity}Anzahl{/s}',
        accessoryArticlesToolBarLabel: '{s name=accessory_articles/toolBar/label}Artikel hinzufügen{/s}',
        accessoryArticlesToolBarDeleteButton: '{s name=accessory_articles/toolBar/delete_button}Markierte Artikel löschen{/s}',
    ...
    createColumns: function(){
        ...
        var columns = [
            ...
            {
                header: me.snippets.accessoryArticlesColumnQuantity,
                dataIndex: 'quantity',
                flex: 1
            },
            {
