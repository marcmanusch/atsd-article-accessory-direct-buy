...
Ext.define('Shopware.apps.Article.model.accessory.Article', {
    ...
    proxy: {
         ...
         */
        api: {
            create: '{url controller="AtsdArticleAccessoryDirectBuy" action="updateGroupArticle"}',
            update: '{url controller="AtsdArticleAccessoryDirectBuy" action="updateGroupArticle"}',
            destroy: '{url controller="AtsdArticleAccessoryDirectBuy" action="deleteGroupArticle"}'
        },
        /**
