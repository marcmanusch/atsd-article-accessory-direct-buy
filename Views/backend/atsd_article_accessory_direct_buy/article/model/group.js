...
Ext.define('Shopware.apps.Article.model.accessory.Group', {
    ...
    proxy: {
        ...
        api: {
            //read out all groups
            read: '{url controller="AtsdArticleAccessoryDirectBuy" action="getAccessoryGroups"}',
            //create groups
            create: '{url controller="AtsdArticleAccessoryDirectBuy" action="createAccessoryGroup"}',
            //edit group
            update: '{url controller="AtsdArticleAccessoryDirectBuy" action="updateAccessoryGroup"}',
            //function to delete groups
            destroy: '{url controller="AtsdArticleAccessoryDirectBuy" action="deleteGroups"}'
        },
