...
Ext.define('Shopware.apps.Article.controller.Accessory', {
    ...
    snippets: {
        accessoryTitle: '{s name=title}Direkt-Kauf{/s}',
        accessoryErrorTitle: '{s name=error_title}Ein Fehler ist aufgetreten{/s}',
        accessorySuccessEditTitle: '{s name=success/edit_title}Erfolgreich editiert{/s}',
        accessorySuccessEditArticleMessage: '{s name=success/edit_article/message}Der Artikel wurde erfolgreich editiert{/s}',
        accessorySuccessEditGroupMessage: '{s name=success/edit_group/message}Die Gruppe wurde erfolgreich editiert{/s}',
        accessoryDeleteMultipleArticlesMessage: '{s name=delete_multiple_articles/message}Sie haben [0] Artikel markiert. Möchten Sie diese wirklich löschen?{/s}',
        accessoryDeleteMultipleArticlesTitle: '{s name=delete_multiple_articles/title}Mehrere Artikel{/s}',
        accessoryDeleteSingleGroupMessage: '{s name=delete_single_group/message}Möchten Sie die Gruppe <b>[0]</b> wirklich löschen?{/s}',
        accessoryDeleteSingleGroupTitle: '{s name=delete_single_group/title}Gruppe löschen{/s}',
        accessoryDeleteMultipleGroupsMessage: '{s name=delete_multiple_groups/message}Sie haben <b>[0]</b> Gruppen markiert. Möchten Sie diese wirklich löschen?{/s}',
        accessoryDeleteMultipleGroupsTitle: '{s name=delete_multiple_groups/title}Gruppe löschen{/s}',
        accessorySuccessDeleteMultipleGroupsTitle: '{s name=success/delete_multiple_groups/title}Gruppen gelöscht{/s}',
        accessorySuccessDeleteMultipleGroupsMessage: '{s name=success/delete_multiple_groups/message}Die Gruppen wurden erfolgreich gelöscht{/s}',
        accessorySuccessCreateGroupTitle: '{s name=success/create_group/title}Gruppe hinzugefügt{/s}',
        accessorySuccessCreateGroupMessage: '{s name=success/create_group/message}Die Gruppe wurde erfolgreich angelegt{/s}',
        accessorySuccessDeleteSingleGroupTitle: '{s name=success/delete_single_group/title}Gruppe gelöscht{/s}',
        accessorySuccessDeleteSingleGroupMessage: '{s name=success/delete_single_group/message}Die Gruppe wurde erfolgreich gelöscht{/s}',
        accessorySuccessDeleteMultipleArticlesTitle: '{s name=success/delete_multiple_articles/title}Artikel gelöscht{/s}',
        accessorySuccessDeleteMultipleArticlesMessage: '{s name=success/delete_multiple_articles/message}Die Artikel wurden erfolgreich gelöscht{/s}',
        accessorySuccessDeleteSingleArticleTitle: '{s name=success/delete_single_article/title}Artikel gelöscht{/s}',
        accessorySuccessDeleteSingleArticleMessage: '{s name=success/delete_single_article/message}Der Artikel wurde erfolgreich gelöscht{/s}'
    },
    ...
    saveOptionName: function(){
        ...
        model.save({
            callback: function(data, operation){
                ...
                var quantity = mergedValues["quantity"];
                form.getRecord().set('quantity', quantity);
